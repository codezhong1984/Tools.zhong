<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="%C%.aspx.cs" Inherits="PanelTracking.PC.SystemDesign.%C%" %>
...
﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TnOwner.aspx.cs" Inherits="PanelTracking.PC.SystemDesign.TnOwner" %>
