<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateHubPlant.aspx.cs" Inherits="PanelTracking.PC.SystemDesign.UpdateHubPlant" %>
...
<body>
                                ...
                                <div class="message-content clear">
                                    ...
                                    <div class="messagebox">
                                        ...
                                        <div class="messagebox-input fl mr10">
                                            <input class="input-text" type="text" name="" id="txtGID" runat="server" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="messagebox">
                                        ...
                                        <div class="messagebox-input fl mr10">
                                            <input class="input-text" type="text" name="" id="txtCOMPANY" runat="server" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="messagebox">
                                        ...
                                        <div class="messagebox-input fl mr10">
                                            <input class="input-text" type="text" name="" id="txtPLANT" runat="server" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="messagebox">
                                        ...
                                        <div class="messagebox-input fl mr10">
                                            <input class="input-text" type="text" name="" id="txtPLANT_NAME" runat="server" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="messagebox">
                                        ...
                                        <div class="messagebox-input fl mr10">
                                            <input class="input-text" type="text" name="" id="txtSAP_CLIENT" runat="server" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="messagebox">
                                        ...
                                        <div class="messagebox-input fl mr10">
                                            <input class="input-text" type="text" name="" id="txtNOTE" runat="server" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="messagebox">
                                        ...
                                        <div class="messagebox-input fl mr10">
                                            <input class="input-text" type="text" name="" id="txtCREATE_DATE" runat="server" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="messagebox">
                                        ...
                                        <div class="messagebox-input fl mr10">
                                            <input class="input-text" type="text" name="" id="txtUPDATE_DATE" runat="server" value="" />
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        var pageobj = new HubPlantUpdate();
        $().ready(function () {
            pageobj.Init();
        });
    </script>
